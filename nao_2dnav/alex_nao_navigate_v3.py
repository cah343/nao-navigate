...
#if an april tag is detected. Once the apriltag-label obstacle is moved,
#nao will continue towards its goal

#Written by: Alex Hirst, 11/6/17
# Undegraduate Researcher, ASL, Cornell University
